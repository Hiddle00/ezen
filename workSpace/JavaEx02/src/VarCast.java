...
public class VarCast 
{
	...
	public static void main(String[] args)
	{
		...
		int avgScore = sumScore / 3;						//평균이 30.3333이지만, avgScore가 int(정수형)이므로 소숫점은 떨어져 나감														
		System.out.println(sumScore);						//sumScore, avgScore 정수값이므로 정수가 출력됨
		System.out.println(avgScore);
		
		double sum = mathScore + korScore + engScore;
		double avg = sum / 3; 								// 실수/정수 ==> 실수가 계산결과 나옴
