...
<body>
	...
	<div class="container text-center border border-primary">
		...
		<div class="row">
			<div class="col">컬럼3</div>
			<div class="col">컬럼4</div>
		</div>
	</div>
...
<br>
<button type="button" class="btn btn-primary">클릭!<span class="badge text-bg-danger">5</span>
</button>
<br>
<button type="button" class="btn btn-success position-relative" >메세지<span class="badge position-absolote top-0 start-100 bg-danger translate-middle">5</span>
</button>

<br>
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		<li class="breadcrumb-item active" aria-current><a href="#">home</a></li>
...
<input type="button" value="버튼2" class="btn btn-secondary">
<button type="button" class="btn btn-outline-primary">버튼3</button>
<button type="button" class="btn btn-primary btn-sm">버튼4</button>
<button type="button" class="btn btn-primary btn-lg">버튼4</button>

<br>

<div id="carouselExampleIndicators" class="carousel slide">
<div class="carousel-indicators" style="backgraund-color:black;">
...
<div class="carousel-inner">
  <div class="carousel-item active">
    <img src="spade-A.png" class="d-block w-100" alt="...">
  </div>
